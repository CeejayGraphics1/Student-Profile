...
urlpatterns = [
    ...
    path('staff_student_details/<int:id>/', views.staff_student_details, name='staff_student_details'),
    ...
    path('staff_search_students/', views.staff_search_students, name='staff_search_students'),
]
